...
L.CB_CURSOR_ENHANCER = "Ring um den Mauszeiger anzeigen (bessere Sichtbarkeit)"
L.CURSOR_COLOR_LABEL = "Ringfarbe:"
L.CURSOR_COLOR_CLASS = "Klassenfarbe"
L.CURSOR_COLOR_WHITE = "Weiß"
L.CB_INTERRUPT_TRACKER = "Zauber-/Interrupt-Tracker anzeigen (ideal für Mythic+)"
L.INTERRUPT_SPELL_LABEL = "Interrupt-Zauber:"
L.INTERRUPT_SPELL_HINT = "Zaubernamen wie im Zauberbuch angezeigt eingeben, dann Enter. Das Fenster ist verschiebbar."
L.INTERRUPT_READY = "BEREIT!"
L.INTERRUPT_NO_SPELL = "Kein Zauber gesetzt"
...
L.RELOAD_DESC = "Bei Problemen die UI neu laden mit\n /reload oder dem Button rechts ->"
L.CB_INFO_WINDOW = "Info-Fenster anzeigen"
L.CB_UNITFRAME_FONTS = "Einheitenrahmen-Schrift anpassen"
